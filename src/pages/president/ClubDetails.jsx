...
const clubs = [
  {
    ...
    image: "/assets/clubs/rotaract.png",
    sname: "rotract",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    image: "/assets/clubs/pahasara1.png",
  },
  {
    id: "4",
...
const ClubDetails = () => {
  ...
  // Find the club details based on the name
  const clubDetails = clubs.find(clubItem => clubItem.name === name) || {};
