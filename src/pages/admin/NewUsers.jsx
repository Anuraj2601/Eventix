        ...
        <table className="w-full">
          <thead className="text-[#AEC90A] text-center tracking-wide p-3">
            <tr>
              ...
              <th className="w-24">Index No.</th>
              <th className="w-52">Reg No.</th>
              <th>Email</th>
          ...
          <tbody>
            <tr className="bg-[#0B0B0B] text-center">
              ...
              <td className="p-3">21000000</td>
              <td className="p-3">2021/CS/000</td>
              <td className="p-3">2021cs000@ucsc.cmb.ac.lk</td>
...
const NewUsers = () => {
    const [activeTab, setActiveTab] = React.useState("allUserRequests");
    const data = [
      {
        label: "All",
        value: "allUserRequests",
        desc: <NewUsersTable />,
      },
      {
        label: "Accepted",
        value: "acceptedUserRequests",
        desc: `Accepted User Requests`,
      },
      {
        label: "Rejected",
        value: "rejectedUserRequests",
        desc: `Rejected User Requests`,
      },
    ];
