...
const MemberElectionForm = () => {
  ...
  //               Apply as a candidate for the election of board of term 24/25
  //             </div>
  ...
  //                 </div>
  //                 <label htmlFor="" className="text-white">
  //                   The board position you would like to apply *
  //                 </label>
  //                 <div className="flex mt-5">
  //                   <input
  //                     type="text"
  //                     placeholder="secretary"
  //                     className="p-3 border-2 border-[#AEC90A] bg-[#0B0B0B] text-white w-full h-full"
  //                   />
  //                 </div>
  //                 <div className="flex mt-9">
  //                   <input
  //                     type="text"
  //                     placeholder="Why You looking forward this Club ?..."
  //                     className="p-3 border-2 border-[#AEC90A] bg-[#0B0B0B] text-white w-full h-full"
  //                   />
  //                 </div>
                ...
                <form action="" className="w-full px-4 md:px-2">
                  ...
                  <div className="flex flex-col gap-3 mt-5">
                    <label htmlFor="motivation" className="text-white">
                      Why do you want to join the board of term 24/25? *
                    </label>
                    <textarea
                      id="motivation"
