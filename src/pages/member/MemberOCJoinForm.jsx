...
const MemberOCJoinForm = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center relative mt-10'>
      <div className='bg-[#AEC90A] text-[#0B0B0B] p-1 rounded-lg font-semibold absolute -top-4'>Join to OC team of Madhack 3.0</div>
      <div className="bg-[#0B0B0B] flex flex-col items-center justify-center border-2 border-[#AEC90A] rounded-xl w-3/5 py-9">
        ...
        <form action="">
          ...
          <label htmlFor="" className="text-white">The organizing comittee position you would like to apply *</label>
