...
const Candidates = ({ activeTab }) => {
    ...
    return (
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="bg-black bg-opacity-90 text-white flex-col  overflow-y-auto min-h-screen">  
        <Typography variant="h5" className="mb-4 text-[#AEC90A] text-center"> THE FINALISTS</Typography>

             <div className="flex w-full">    <div className="w-1/4  p-4">
