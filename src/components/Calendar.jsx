      ...
      <div className="max-w-md px-4 mx-auto sm:px-7 md:max-w-4xl md:px-6 bg-[#050505]">
        <div className="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
                  ...
                  <div className="w-1 h-1 mx-auto mt-1 flex flex-col">
                    {meetings.some((meeting) =>
                      isSameDay(parseISO(meeting.startDatetime), day)
                        ...
                        <>
                        <div className="w-1.5 h-1.5 rounded-full bg-[#0080C8]">
          ...
          <section className="mt-12 md:mt-0 md:pl-14 bg-black">
            <h2 className="font-semibold text-[#AEC90A] mt-4">
              Schedule for{' '}
            ...
            <ol className="mt-4 space-y-1 text-sm leading-6 text-gray-500">
              {selectedDayMeetings.length > 0 ? (
                ...
                <p className='text-[#AEC90A]'>No meetings for today,
                <div className='text-white'>Stay tuned for upcoming Events</div>
                </p>
...
function Meeting({ meeting }) {
  ...
  return (
    <li className="flex items-center px-4 py-2 space-x-4 group rounded-xl focus-within:bg-gray-100 hover:bg-[#171717]">
      <img
