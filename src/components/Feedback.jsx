      ...
      <div className="flex flex-wrap h-full p-2">
        {feedbackItems.map(item => (
          ...
          >
            ...
            />
            <div className="w-full px-2  ml-0  h-40 flex flex-col justify-between rounded-2xl"  style={{ 
                    boxShadow: '0 8px 16px rgba(0, 0, 0, 0.9), 0 0 8px rgba(255, 255, 255, 0.1)' 
                  }}>
              {isFormVisible ? (
                ...
                <div className="flex flex-col h-full ml-2">
                  <div>
                    <h3 className="text-white text-xl font-bold mb-2 py-2">{item.name} &nbsp; &nbsp; &nbsp; &nbsp;  <span className="text-yellow-400 cursor-pointer mr-4" onClick={() => handleEmojiClick(item.id, '😊')}>😊 {emojiRatings[item.id]?.['😊'] || 0}</span>
                    ...
                    <p className="text-gray-400 mb-2">{item.details} <button
