...
const MainAnnouncement = () => {
    ...
    const clubAnnouncements = [
        ...
        },
        {
            ...
            newAnnouncements: 2,
            announcements: [
                { id: 1, title: 'Cybersecurity Workshop', description: 'Workshop on the latest trends and practices in cybersecurity.', type: 'Event', date: '2024-08-02', time: '11:00 AM' ,location: 'S203', postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 2, title: 'Monthly Security Meeting', description: 'Discuss recent security threats and solutions in our monthly meeting.', type: 'Meeting', date: '2024-08-07', time: '03:00 PM',location: 'S203' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 3, title: 'New Data Privacy Policy', description: 'Update on new data privacy regulations and compliance.', type: 'Update', date: '2024-08-12', time: '10:00 AM' ,location: 'Auditorium' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 4, title: 'ISACA Certification Seminar', description: 'Seminar on ISACA certification and career advancement.', type: 'Event', date: '2024-08-17', time: '02:00 PM',location: 'Auditorium' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 5, title: 'Annual Security Conference', description: 'Join us for our annual conference on cybersecurity and industry trends.', type: 'Event', date: '2024-08-22', time: '09:00 AM',location: 'Auditorium' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 6, title: 'ISACA Community Outreach', description: 'Participate in community outreach programs and help raise awareness.', type: 'Update', date: '2024-08-28', time: '01:00 PM', location: 'Auditorium' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
            ],
        },
        {
            id: 3,
            ...
            newAnnouncements: 5,
            announcements: [
                { id: 1, title: 'Volunteering Opportunity', description: 'Volunteer for various community service projects organized by Rotract.', type: 'Event', date: '2024-08-03', time: '10:00 AM' ,location: 'S203' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 2, title: 'Rotract Club Meeting', description: 'Monthly meeting to plan and discuss upcoming events.', type: 'Meeting', date: '2024-08-08', time: '02:00 PM' ,location: 'S203' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 3, title: 'Charity Fundraiser', description: 'Help raise funds for charity through various events and activities.', type: 'Event', date: '2024-08-13', time: '12:00 PM',location: 'S203' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 4, title: 'Guest Speaker Event', description: 'Attend a talk by a guest speaker on community service and leadership.', type: 'Event', date: '2024-08-18', time: '05:00 PM',location: 'S203' , postedDate: '2024-07-25', postedTime: '10:00 AM'},
                { id: 5, title: 'Rotract Social Event', description: 'Join us for a social gathering to meet new members and have fun.', type: 'Event', date: '2024-08-23', time: '07:00 PM',location: 'S203', postedDate: '2024-07-25', postedTime: '10:00 AM' },
            ],
        }
    ];
