...
import { BsBell } from "react-icons/bs";
  ...
  export function NotificationsMenu() {
    return (
      <Menu>
        <MenuHandler>
          <IconButton variant="text"  className="-ml-3 -mt-2">
        ...
        <MenuList className="flex flex-col gap-2 bg-stone-950 ">
          <MenuItem className="flex items-center gap-4 py-2 pl-2 pr-8">
            ...
            /> */}
            <div className="flex flex-col gap-1  hover:bg-[#AEC90A]">
              <Typography variant="small" color="white" className="font-semibold">
                Tania send you a message
              </Typography>
              <Typography className="flex items-center gap-1 text-sm font-medium text-slate-500">
                <ClockIcon />
                13 minutes ago
              </Typography>
            </div>
