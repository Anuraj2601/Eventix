...
//   const [mobileNumber, setMobileNumber] = useState("123-456-7890");
//   const [email, setEmail] = useState("student@example.com");
//   const [regNo, setRegNo] = useState("2021cs092");
//   const [yearOfStudy, setYearOfStudy] = useState("3rd Year");
//   const [firstName, setFirstName] = useState("John");
//   const [lastName, setLastName] = useState("Doe");
//   const [hobby, setHobby] = useState("Photography");
...
//     // Add logic to save the bio if needed
//   };
...
//                       className="mt-2 px-4 py-2 text-white rounded-lg hover:bg-green-500"
...
//                       className="px-4 py-2 text-white rounded-lg hover:bg-green-500"
//                       style={{ backgroundColor: "#AEC90A" }}
//                     >
//                       Edit
//                     </button>
...
//                       <p className="text-sm">{club.position}</p>
//                     </div>
//                   </div>
//                 ))}
//               </div>
