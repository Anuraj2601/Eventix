    ...
    <div className='bg-[#1E1E1E] p-6 mx-4 my-2 rounded-2xl'>
        <div className="flex items-center justify-between">
            <div className="flex items-center justify-center gap-4">
              <img src={csa} alt="CSA Student Chapter" className='w-12 h-12 rounded-full'/>
        ...
        <div className="flex items-center justify-between p-4 ml-12">
            <p className='text-white w-4/5'>
                “Reminder: Upcoming Meeting” Dear student, your upcoming meeting for the CSA Student Chapter Design team is scheduled for tomorrow. Stay tuned for further updates and make sure to prepare your presentation. We will provide details about the exact time and location soon.
            </p>
